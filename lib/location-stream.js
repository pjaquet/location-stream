...
var location_stream_url = 'https://stream.twitter.com/1.1/statuses/filter.json',
 ...
 *
 */
Stream.prototype.stream = function(locations) {

    var bboxes = [];
    locations.forEach(function(item) {
        var degrees = item.radius * 0.0089982311916; //this is very roughly 1km
        bboxes.push(item.lon - degrees);
        bboxes.push(item.lat - degrees);
        bboxes.push(item.lon + degrees);
        bboxes.push(item.lat + degrees);
